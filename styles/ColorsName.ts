...
export const color2Name = (hexColor: string) => {
  const color = hexColor.split("#")[1].toUpperCase();
  const colorName = names.find((colorName) => colorName[0] === color);
  const name = colorName ? colorName[1] : "";
  return name;
};
